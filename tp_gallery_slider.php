...
function tp_gallery_slider($output, $attr) {
	...
	*/
	...
	echo '<div class="tp_gallery_slider">';
		
		echo '<div id="tp_panel">';
			
			echo '<img id="largeImage" alt="'.$first_value->post_title.'" src="'.$big_image_src[0].'" width="'.$big_image_src[1].'" height="'.$big_image_src[2].'" />';
			if($tp_display_alt == 'yes'){
				echo '<div id="description">';
					echo $first_value->post_title;
				echo '</div>';//description
			}//$tp_display_alt == 'yes'

		echo '</div>';//tp_panel
		
		echo '<div id="tp_thumbs">';
